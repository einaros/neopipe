...
var grammar = {
    ...
    {"name": "instruction", "symbols": ["entity", "__", "relation", "__", "entity"], "postprocess": ([a,,b,,c]) =>  ({ type: 'connect', left: a, relationship: b, right: c })},
    ...
    {"name": "relation", "symbols": ["sqstring"], "postprocess": id},
    {"name": "relation", "symbols": ["dqstring"], "postprocess": id},
    {"name": "relation", "symbols": ["word"], "postprocess": id},
    ...
    {"name": "properties", "symbols": [{"literal":"("}, "_", "property_list", "_", {"literal":")"}], "postprocess": ([,,p]) => p.reduce((a, cv) => { a[cv[0]] = cv[1]; return a; }, {})},
